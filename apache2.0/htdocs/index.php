...
<body>
  <nav class="blue">
    <div class="nav-wrapper">
      <a href="#" style="padding:0px 10px;font-family: 'Julius Sans One', sans-serif;" class="brand-logo">FS-FastShare</a>
    ...
    <section class="container">
       <h3 style="font-family: 'Rokkitt', serif;">FastShare - Share files between Desktops...</h3>
    </section>
    ...
    <section class="container">
        ...
        <p style="color:#fff;">The files you want to share should be in the ./apache2.0/htdocs/files folder from the root.</p>
    </section>
</body>
</html>
